 ...
 */
class SaveMessageListener extends MessageBaseTemplate
{
    /**
     ...
     * @const string
     */
    public const QUEUE_NAME = "incoming.save";
    ...
    /**
     * Конструктор SaveMessageListener
     */
